"""Loss functions for Stage 2 training."""
...
class VGG16(nn.Module):
    ...
    def forward(self, image):
        ...
        Returns:
            List of feature maps from different VGG16 layers.
        """
        results = [image]
        for i in range(3):
...
class ContentPerceptualLoss(nn.Module):
    """Content perceptual loss using VGG16 features."""
    ...
    def calculate_loss(self, generated_images, target_images, device):
        ...
        Args:
            ...
            target_images: Target image tensor.
