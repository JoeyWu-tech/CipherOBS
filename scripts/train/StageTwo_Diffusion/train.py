...
def main():
    ...
    # if args.scr_ckpt_path!=None:
    #     # model.load_state_dict(torch.load(f"{args.scr_ckpt_path}/total_model.pth"))
    #     print("load pretrained model")

    #     para = torch.load(f"{args.scr_ckpt_path}/total_model.pth")
    #     model.unet.load_state_dict(para.unet.state_dict())
    #     model.style_encoder.load_state_dict(para.style_encoder.state_dict())
    #     model.content_encoder.load_state_dict(para.content_encoder.state_dict())
    ...
    for idx, (name, param) in enumerate(model.named_parameters()):
        ...
        # model.ids_encoder.requires_grad_(False)
    # print(a)
            ...
            if accelerator.sync_gradients:
                ...
                if accelerator.is_main_process:
                    if global_step % args.ckpt_interval == 0:
                        ...
                        torch.save(model.module.ids_style_encoder.state_dict(), f"{save_dir}/content_encoder.pth")
                        torch.save(model.module, f"{save_dir}/total_model.pth")
