...
Font_args = arg_parse()
Font_args.demo = True
Font_args.ckpt_dir = '/hpc2hdd/home/gzhang292/project13/temp/OBSD/FontDiffuser/outputs/sim2obc_baseline/global_step_80000'
...
def run_fontdiffuer(source_image,
    ...
    if reference_image is None:
        reference_image = Image.open('MyData/test/target/test_3.png')
    out_image = sampling(
        args=Font_args,
        pipe=pipe,
...
# 读取refine_path下所有图片
refine_path = '/hpc2hdd/home/gzhang292/project13/temp/OBSD/FontDiffuser/data_zhanggj/test/ContentImage'                          #'After/result_90/run_1
refine_result_path = '/hpc2hdd/home/gzhang292/project13/temp/OBSD/FontDiffuser/data_zhanggj/test/inference'                                         #After/result_refined_90/run_1_24
