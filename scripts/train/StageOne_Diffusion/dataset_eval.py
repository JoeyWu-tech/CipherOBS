...
class MyDataset(torch.utils.data.Dataset):
    ...
    def __init__(self, dir, patch_size, n, keep_image_size, transforms, parse_patches=True):
        ...
        already = [] #os.listdir("/home/hdd2/zhanggangjian/new_data/train/input_stage1ouput/run_1")
        ...
        input_names = new.copy()
        gt_names= new_target.copy()
    ...
    def get_images(self, index):
        ...
        try:
            gt_img = PIL.Image.open(os.path.join(self.dir, 'input', gt_name)).convert(
                'RGB') if self.dir else PIL.Image.open(gt_name)
        except:
            gt_img = PIL.Image.open(os.path.join(self.dir, 'input', gt_name)).convert('RGB') if self.dir else \
